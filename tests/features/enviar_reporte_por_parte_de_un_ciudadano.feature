...
Característica: Enviar reporte por parte de un ciudadano
  ...
  Esquema del escenario: Enviar un reporte de forma asistida
    Dado que un ciudadano llamado "<nombre>" con correo "<correo>" e identificación "<identificacion>" está en comunicación con un asistente
    Y una institución municipal llamada "<nombre1>" con email "<email>"
    ...
    Ejemplos:
      | nombre        | correo             | identificacion | nombre1           | email                     | asunto         | descripcion                                | ubicacion           |
