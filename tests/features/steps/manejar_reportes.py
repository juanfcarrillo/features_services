...
@step("un problema ha sido identificado con un tipo, descripción y ubicación")
...
@step("el ciudadano reporta el problema al sistema")
...
@step('registrar el reporte con un estado inicial "Pendiente"')
